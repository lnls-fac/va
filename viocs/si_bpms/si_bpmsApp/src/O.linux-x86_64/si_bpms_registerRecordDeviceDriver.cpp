...
/* Generated from ../O.Common/si_bpms.dbd */
...
int si_bpms_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/fac_files/code/va/viocs/si_bpms";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"si_bpms_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    si_bpms_registerRecordDeviceDriver(*iocshPpdbbase);
}
