...
#     _dict = {}
#
#     get_element_names = _sirius.bo.device_names.get_element_names
#
#     # Add fake Corrector pvs for errors
#     _dict.update(get_element_names(family_data, 'corr', prefix='BOFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'corr', prefix='BOFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'corr', prefix='BOFK-ErrR-'))
#     # Add fake BEND pvs for errors
#     _dict.update(get_element_names(family_data, 'bend', prefix='BOFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'bend', prefix='BOFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'bend', prefix='BOFK-ErrR-'))
#     # Add fake QUAD pvs for errors
#     _dict.update(get_element_names(family_data, 'quad', prefix='BOFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'quad', prefix='BOFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'quad', prefix='BOFK-ErrR-'))
#     # Add fake SEXT pvs for errors
#     _dict.update(get_element_names(family_data, 'sext', prefix='BOFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'sext', prefix='BOFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'sext', prefix='BOFK-ErrR-'))
#     # Add fake pulsed magnets pvs for errors
#     _dict.update(get_element_names(family_data, 'pulsed_magnets', prefix='BOFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'pulsed_magnets', prefix='BOFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'pulsed_magnets', prefix='BOFK-ErrR-'))
#
#
...
#     elements = []
#     elements += model.families.families_dipoles()
