...
#     _dict = {}
#     _dict.update(get_element_names(family_data, 'fc', prefix='SIFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'fc', prefix='SIFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'fc', prefix='SIFK-ErrR-'))
#     # Add fake BEND pvs for errors
#     _dict.update(get_element_names(family_data, 'bend', prefix='SIFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'bend', prefix='SIFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'bend', prefix='SIFK-ErrR-'))
#     # Add fake QUAD pvs for errors
#     _dict.update(get_element_names(family_data, 'quad', prefix='SIFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'quad', prefix='SIFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'quad', prefix='SIFK-ErrR-'))
#     # Add fake SEXT pvs for errors
#     _dict.update(get_element_names(family_data, 'sext', prefix='SIFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'sext', prefix='SIFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'sext', prefix='SIFK-ErrR-'))
#     # Add fake pulsed magnets pvs for errors
#     _dict.update(get_element_names(family_data, 'pulsed_magnets', prefix='SIFK-ErrX-'))
#     _dict.update(get_element_names(family_data, 'pulsed_magnets', prefix='SIFK-ErrY-'))
#     _dict.update(get_element_names(family_data, 'pulsed_magnets', prefix='SIFK-ErrR-'))
#
...
#                 d = {'SIFK-ErrX-'+ key : {'cv': idx},
#                      'SIFK-ErrY-'+ key : {'cv': idx},
#                      'SIFK-ErrR-'+ key : {'cv': idx}}
#                 _dict.update(d)
#
