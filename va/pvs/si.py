...
_el_names = { # All these Family names must be defined in family_data dictionary
    ...
    #        model.families.families_skew_correctors()
    #        ),
    'MA': (model.families.families_horizontal_correctors() +
           model.families.families_vertical_correctors()
           ),
    'PS': (model.families.families_horizontal_correctors() +
           model.families.families_vertical_correctors()
           ),
    ...
    'PM': ['InjDpKckr', 'InjNLKckr', 'PingH'],
    'PU': ['InjDpKckr', 'InjNLKckr', 'PingH'],
    'TI': ['InjDpKckr', 'InjNLKckr', 'PingH'],
}
...
# This relation should be implemented and available from siriuspy/magnet !
    ...
    # (('QDA','QDB1','QDB2','QDP1','QDP2') , ('si-quadrupole-q14-fam.txt',+1)),
    # (('QFA','Q1','Q2','Q3','Q4')         , ('si-quadrupole-q20-fam.txt',+1)),
    # (('QFB','QFP')                       , ('si-quadrupole-q30-fam.txt',+1)),
    # (('QS',)                             , ('si-sextupole-s15-qs.txt',+1)),
    # (('SFA0','SFA1','SFA2')              , ('si-sextupole-s15-fam.txt',-1)),
    # (('SFB0','SFB1','SFB2')              , ('si-sextupole-s15-fam.txt',-1)),
    # (('SFP0','SFP1','SFP2')              , ('si-sextupole-s15-fam.txt',-1)),
    # (('SDA0','SDA1','SDA2','SDA3')       , ('si-sextupole-s15-fam.txt',+1)),
    # (('SDB0','SDB1','SDB2','SDB3')       , ('si-sextupole-s15-fam.txt',+1)),
    # (('SDP0','SDP1','SDP2','SDP3')       , ('si-sextupole-s15-fam.txt',+1)),
